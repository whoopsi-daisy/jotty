...
export const CategoryTreeSelector = ({
  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
      ...
      {isOpen && (
        <div className={cn("absolute w-full z-60 mt-1 bg-background border border-input rounded-md shadow-lg max-h-60 overflow-y-auto", isInModal ? "bottom-full lg:top-full lg:bottom-auto" : "top-full")}>
          <div className="p-2">
            <div
              className={cn(
