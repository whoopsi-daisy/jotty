...
import { getLanguageFromCode, languageIcons, codeBlockLanguages } from "@/app/_utils/markdownUtils";
import { Code, ChevronDown } from "lucide-react";
import { useState, useRef, useEffect } from "react";

export default function CodeBlockComponent({ node, updateAttributes, editor }: any) {
    ...
    return (
        <NodeViewWrapper className="code-block-wrapper">
            <div className="relative group my-4 overflow-hidden" style={{ backgroundColor: '#1a1a1a' }}>
                {detectedLanguage !== 'text' && (
                    <div className="flex items-center justify-between px-3 py-1" style={{ backgroundColor: '#1a202c', borderBottom: '1px solid #4a5568' }}>
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            {isDropdownOpen && (
                                <div className="fixed bg-background border border-border rounded-md shadow-lg z-[9999] min-w-[200px] max-h-[300px] overflow-y-auto"
                                    style={{
