...
export async function getSharedItemsAction(): Promise<Result<{
    sharedWithMe: {
...
export async function getItemsSharedWithMeAction(): Promise<Result<{
    checklists: SharedItem[];
    documents: SharedItem[];
}>> {
    try {
...
export async function getItemsSharedByMeAction(): Promise<Result<{
    checklists: SharedItem[];
    documents: SharedItem[];
}>> {
    try {
