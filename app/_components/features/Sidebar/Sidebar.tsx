...
import { DeleteCategoryModal } from "@/app/_components/ui/modals/CategoryModals/DeleteCategoryModal";
import { RenameCategoryModal } from "@/app/_components/ui/modals/CategoryModals/RenameCategoryModal";
import { EditChecklistModal } from "@/app/_components/ui/modals/ChecklistModals/EditChecklistModal";
import { EditNoteModal } from "@/app/_components/ui/modals/NotesModal/EditNoteModal";
      ...
      >
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-2 space-y-4">
            <SharedItemsList
              items={mode === "checklists" ? checklists : notes}
